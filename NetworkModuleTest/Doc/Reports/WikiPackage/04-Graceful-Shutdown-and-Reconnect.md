...
Windows 경로에서 TestServer는 DB 연결이 끊기면 재연결 스레드를 실행한다.
...
- 재연결 루프: `Server/TestServer/src/TestServer.cpp:669`
- 에러 구분: `.../TestServer.cpp:707`
...
- 전체 순서: `Server/TestServer/src/TestServer.cpp:222`

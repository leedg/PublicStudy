...
public:
     ...
     */
    bool RegisterHandler(Interfaces::MessageType type, MessageCallback callback);
...
protected:
     ...
     */
    virtual std::vector<uint8_t> SerializeMessage(const Interfaces::Message& message);
     ...
     * @return Message type
     */
    static Interfaces::MessageType GetMessageType(const uint8_t* data, size_t size);

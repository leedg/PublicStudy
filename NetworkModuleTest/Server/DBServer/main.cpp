// TestDBServer 진입점 - 데이터베이스 서버 초기화 및 실행
...
#ifdef _WIN32
// 콘솔 컨트롤 핸들러 — CTRL_CLOSE_EVENT/창 닫기 시 server.Stop()이 실행되도록 보장.
...
int main(int argc, char* argv[])
{
    ...
    #endif
    // 창 닫기 / taskkill 시 정상 종료를 위한 ConsoleCtrlHandler 등록
    ...
    // 메인 루프 — SIGINT/SIGTERM, ConsoleCtrlHandler, 또는 Named Event 대기.

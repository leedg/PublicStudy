 ...
 * Manages database connection pool and provides server-specific data access
 * methods
 *
 * Naming Convention:
...
class TestServerDatabaseManager
{
  public:
	 ...
	 * @param odbcConnectionString ODBC DSN connection string (e.g.,
	 ...
	 */
	bool PersistPlayerGameState(uint64_t userId,

...
**C++17 기반 크로스플랫폼 네트워크 엔진 테스트베드**
Windows(IOCP/RIO) · Linux(epoll/io_uring) · macOS(kqueue) 백엔드를 단일 인터페이스(`INetworkEngine`)로 추상화하고, 실제 클라이언트-서버 부하 환경에서 세션 관리 · 비동기 DB · 재연결 흐름을 검증합니다.
...
<p align="center">
  <img src="Doc/WikiDraft/ServerStructure/assets/01-overall-architecture.png" alt="Overall Architecture" width="860"/>
</p>
...
<p align="center">
  <img src="Doc/WikiDraft/ServerStructure/assets/02-session-layer.png" alt="Session Layer" width="760"/>
</p>
...
<p align="center">
  <img src="Doc/WikiDraft/ServerStructure/assets/03-packet-and-asyncdb-flow.png" alt="Packet and Async DB Flow" width="760"/>
</p>
...
```powershell
# epoll + io_uring 통합 테스트 (이미지 자동 빌드 포함)
...
# 전체 빌드 (TestServer, DBServer, TestClient 포함)
...
> PowerShell 스크립트는 포트 충돌 시 자동으로 다음 빈 포트로 fallback합니다.
...
| 문서 | 내용 |
|------|------|
| [Doc/01_ProjectOverview.md](Doc/01_ProjectOverview.md) | 프로젝트 범위 · 현재 상태 · 변경 이력 |
| [Doc/02_Architecture.md](Doc/02_Architecture.md) | 런타임 아키텍처 · 모듈 관계도 |
| [Doc/03_Protocol.md](Doc/03_Protocol.md) | PacketDefine · ServerPacketDefine 프로토콜 |
| [Doc/04_API.md](Doc/04_API.md) | CLI 옵션 · 주요 C++ API |
| [Doc/05_DevelopmentGuide.md](Doc/05_DevelopmentGuide.md) | **플랫폼별 빌드/실행/테스트 상세 가이드** |
| [Doc/06_SolutionGuide.md](Doc/06_SolutionGuide.md) | 솔루션 · 프로젝트 구조 |
| [Doc/07_VisualMap.md](Doc/07_VisualMap.md) | 코드 디렉터리 ↔ 문서 매핑 |
| [Doc/README.md](Doc/README.md) | 전체 문서 인덱스 |

**상세 보고서:**

| 문서 | 내용 |
|------|------|
| [Doc/Reports/WikiPackage/](Doc/Reports/WikiPackage/) | Wiki 게시용 최종 패키지 (다이어그램 포함) |
| [Doc/Reports/ExecutiveSummary/](Doc/Reports/ExecutiveSummary/) | 요약 보고서 패키지 |
| [Doc/Reports/TeamShare/](Doc/Reports/TeamShare/) | 팀 공유용 보고서 |
| [Doc/Performance/Logs/](Doc/Performance/Logs/) | Windows · Linux 성능 테스트 결과 |

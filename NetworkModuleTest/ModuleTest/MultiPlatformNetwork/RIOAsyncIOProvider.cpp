...
RIOAsyncIOProvider::RIOAsyncIOProvider()
	: mCompletionQueue(RIO_INVALID_CQ), mInitialized(false)
{
}
...
// Replace heavy implementation with a stub for module tests
std::unique_ptr<AsyncIOProvider> CreateRIOProvider() { return nullptr; }

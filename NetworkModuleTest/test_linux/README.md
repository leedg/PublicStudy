...
```
NetworkModuleTest/
├── Docs/Performance/Logs/          ← 테스트 결과가 여기 저장됨 (볼륨 마운트 대상)
...
────────────────────────────────       ───────────────────────────────
Docs/Performance/Logs/    ←──── 볼륨 마운트 ────→  /workspace/Docs/Performance/Logs/
...
git add NetworkModuleTest/Docs/Performance/Logs/<폴더명>/

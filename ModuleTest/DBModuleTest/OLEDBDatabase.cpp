...
void OLEDBStatement::setQuery(const std::string &query) { query_ = query; }
...
{
	// For module tests return an empty result set. In a full implementation
	// this would execute the query via OLE DB provider and populate results.
	prepared_ = true;

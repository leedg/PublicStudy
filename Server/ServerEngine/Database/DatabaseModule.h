 ...
 * different database systems (ODBC, OLEDB, MySQL, PostgreSQL, SQLite).
 *
 * Features:
 * - Abstract database interface (IDatabase, IConnection, IStatement,
 * IResultSet)
 ...
 */
inline std::unique_ptr<ConnectionPool>
createConnectionPool(const DatabaseConfig &config)
{
